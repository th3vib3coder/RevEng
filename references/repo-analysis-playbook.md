...
3. Run `scripts/repo_map.py` to collect entrypoints, dependencies, routes, plugin surfaces, config files, and static risks.
4. Run `scripts/repo_corpus_export.py` to emit a JSONL corpus suitable for RAG/MCP ingestion.
5. Read the generated JSON/JSONL and produce a Markdown report with evidence-backed claims.
